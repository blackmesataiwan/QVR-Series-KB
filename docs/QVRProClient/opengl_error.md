...
This error indicates that your graphics card is too old and does not support OpenGL 2.1. It is recommended that you replace the graphics card.<br/>
If you still need to open QVR Pro Client, the following methods may help temporarily operate in this old environment:
...
- Double-click on the shortcut of QVR Pro Client, the upper left corner will display the words **"SW Render"**.<br/>
<img src="/assets/qvrproclient/sw_render.png" width="80%"/>
